...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private val resolutionLauncher =
        registerForActivityResult(
            ...
            when (result.resultCode) {
                ...
                RESULT_CANCELED -> {
                    Toast.makeText(this@MapsActivity, "Anda harus mengaktifkan GPS untuk menggunakan aplikasi ini!", Toast.LENGTH_SHORT).show()
                }
            }
        }
    ...
    private fun checkPermisson(permission: String): Boolean {
    ...
    private fun getMyLastLocation() {
        if (checkPermisson(Manifest.permission.ACCESS_FINE_LOCATION) &&
            checkPermisson(Manifest.permission.ACCESS_COARSE_LOCATION)
            ) {
